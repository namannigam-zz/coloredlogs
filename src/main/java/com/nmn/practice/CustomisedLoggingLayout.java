 ...
 */
public class CustomisedLoggingLayout extends PatternLayout {

    /**
     * Constructs a PatternLayout using the DEFAULT_LAYOUT_PATTERN.
     * The default pattern just produces the application supplied message.
     */
    public CustomisedLoggingLayout() {
     ...
     */
    public CustomisedLoggingLayout(String pattern) {
        super(pattern);
    }
     ...
     * @return log type and attributes combination
     */
    ...
    /**
     * deciding the foreground color
     *
     * @param fgColorName color for foreground
     * @return color name
     */
    ...
    /**
     * deciding the background color
     *
     * @param bgColorName color for log background
     * @return color name
     */
    ...
    /**
     * deciding the attribute of log
     *
     * @param attributeName attribute for log
